...
export default function Loader() {
  ...
  return (
    <Stack direction="vertical" align="center" justify="center" style={styles.container}>
      <ActivityIndicator style={indicatorStyle} color={indicatorColor} />
      <Typography.Text size="callout">{t("Settings.ConnectedServicesScreen.loadingResults")}</Typography.Text>
    </Stack>
  );
}
