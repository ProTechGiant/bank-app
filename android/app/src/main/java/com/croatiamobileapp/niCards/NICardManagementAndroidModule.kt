package com.croatiamobileapp.niCards;
...
class NICardManagementAndroidModule (reactContext: ReactApplicationContext): ReactContextBaseJavaModule(reactContext) {
    override fun getName() = "NICardManagementAndroidModule";
