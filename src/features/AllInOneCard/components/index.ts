...
export { default as MyCurrencies } from "./MyCurrencies";
...
export { default as Card } from "./selectCard/Card";
export { default as NormalVisaCard } from "./selectCard/NormalVisaCard";
