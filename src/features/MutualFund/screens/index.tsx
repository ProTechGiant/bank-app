...
export { default as MutualFundMonthlyPaymentScreen } from "./MutualFundMonthlyPaymentScreen";
...
export { default as MutualFundOverViewDetailsScreen } from "./MutualFundOverViewDetailsScreen";
