...
export default function DeviceManagementScreen() {
  ...
  const { mutateAsync: manageDevice } = useManageDevice();
  ...
  const handleOnRigisterDevice = async () => {
    try {
      await manageDevice({ ActionId: ActionsIds.Register, isvaUserId: user?.IsvaUserId });
    } catch (error) {
      warn("Error", error);
    }
  ...
  const handleOnDeRigisterDevice = async () => {
    try {
      await manageDevice({ ActionId: ActionsIds.Deregister, isvaUserId: user?.IsvaUserId });
    ...
    <Page testID="Settings.DeviceManagement:Page" insets={["left", "right", "bottom", "top"]}>
      ...
      <ScrollView keyboardShouldPersistTaps="handled">
            ...
            renderItem={({ item }) => (
              <>
                ...
                {item.RegisteredDevice === 1 ? (
                  ...
                  <Pressable onPress={() => setIsRigisterModalVisible(true)}>
                    <Stack
        ...
        <NotificationModal
          ...
          buttons={{
            primary: (
              <Button onPress={handleOnDeRigisterDevice} testID="Settings.DeviceManagement:unRigisterConfirm">
        ...
        <NotificationModal
          ...
          buttons={{
            primary: (
              <Button onPress={handleOnRigisterDevice} testID="Settings.DeviceManagement:rigisterConfirm">
